...
import static com.example.englishapp.data.database.Constants.KEY_ANSWER;
import static com.example.englishapp.data.database.Constants.KEY_COLLECTION_QUESTIONS;
import static com.example.englishapp.data.database.Constants.KEY_NUMBER_OF_OPTIONS;
import static com.example.englishapp.data.database.Constants.KEY_OPTION;
import static com.example.englishapp.data.database.Constants.KEY_QUESTION_ID;
import static com.example.englishapp.data.database.Constants.KEY_TEST_ID;
import static com.example.englishapp.data.database.Constants.KEY_TEST_QUESTION;
...
public class DataBaseQuestions {
    ...
    public void createQuestionData(ArrayList<QuestionModel> listOfQuestions, String testID, CompleteListener listener) {
        ...
        for(int i=0; i < listOfQuestions.size(); i++) {
            ...
            questionData.put(KEY_QUESTION_ID, DataBaseCategories.CHOSEN_CATEGORY_ID + "_" + testID + "_" + i);
            ...
            DocumentReference questionDocument = DATA_FIRESTORE
                    ...
                    .document(DataBaseCategories.CHOSEN_CATEGORY_ID + "_" + testID +"_" + i);
    ...
    public void loadQuestions(CompleteListener listener) {
        ...
        DATA_FIRESTORE.collection(KEY_COLLECTION_QUESTIONS)
            .whereEqualTo(KEY_TEST_ID, DataBaseTests.CHOSEN_TEST_ID)
            .get()
